// src/components/profile/Compare.jsx
...
const Compare = () => {
    ...
    // Calculate discount percentage for special offers
    const calculateDiscount = (product) => {
        if (!isSpecialOffer(product.id)) return null;
        return product.originalPrice 
            ? Math.round(((product.originalPrice - product.price) / product.originalPrice) * 100)
            : 0;
    };

    // Handle add to cart from compare view
    ...
    const comparisonAttributes = [
        ...
        },
        {
            ...
            show: (product) => isSpecialOffer(product.id)
        },
        {
            name: 'Discount',
        ...
        {
            name: 'Fabric',
            key: 'specifications.fabric',
            format: (value) => value || 'Not specified'
        },
        {
            name: 'Work Type',
            key: 'specifications.work',
            format: (value) => value || 'Not specified'
        },
        {
            name: 'Season',
            key: 'specifications.season',
            format: (value) => value || 'All Season'
        },
        {
            name: 'Occasion',
            key: 'specifications.occasion',
            format: (value) => value || 'Multi-purpose'
        },
        {
            name: 'Delivery',
            icon: <MdOutlineLocalShipping className="inline mr-2" />,
            key: null,
            calculate: () => '3-5 business days'
        },
        {
            name: 'In Stock',
            key: 'inStock',
