        ...
        <div className="flex justify-between items-center py-3">
          ...
          <div className="flex items-center space-x-4 md:space-x-6">
            ...
            {user ? (
              ...
              <Link to="/login" className="hidden lg:flex items-center gap-2 text-gray-600 hover:text-red-500">
                <FiUser size={22} />
                <span>Login</span>
              </Link>
            )}
            
            <Link to="/profile/compare" className="hidden lg:flex items-center text-gray-600 hover:text-red-500 relative">
             ...
             <Link to="/profile/wishlist" className="hidden lg:flex items-center text-gray-600 hover:text-red-500 relative">
                <FiHeart size={22} />
            ...
            <div className="overflow-y-auto" style={{ height: 'calc(100vh - 150px)' }}>
                {activeMobileTab === 'menu' && (
                    <nav className="flex flex-col space-y-2">
                        <button onClick={() => handleNavLinkClick('/')} className="text-left py-2 px-2 rounded hover:bg-gray-700">Home</button>
                        <button onClick={() => handleNavLinkClick('/about')} className="text-left py-2 px-2 rounded hover:bg-gray-700">About Us</button>
                        <button onClick={() => handleNavLinkClick('/shop')} className="text-left py-2 px-2 rounded hover:bg-gray-700">Shop</button>
                        <button onClick={() => handleNavLinkClick('/contact')} className="text-left py-2 px-2 rounded hover:bg-gray-700">Contact Us</button>
                        ...
                        {user ? (
                            ...
                            <>
                                <button onClick={() => handleNavLinkClick('/login')} className="text-left py-2 px-2 rounded hover:bg-gray-700">Login</button>
                                <button onClick={() => handleNavLinkClick('/register')} className="text-left py-2 px-2 rounded hover:bg-gray-700">Register</button>
                            </>
                        )}
                    </nav>
                )}
